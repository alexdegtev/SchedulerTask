...
namespace GanttChart
{
    ...
    public partial class Chart : UserControl
    {
        ...
        /// <summary>
        /// Get or set header3 pixel height
        /// </summary>
        [DefaultValue(20)]
        public int HeaderThreeHeigt { get; set; }
        ...
        {
            return row * this.BarSpacing + this.HeaderTwoHeight + this.HeaderOneHeight + this.HeaderThreeHeigt;
        }
        ...
        private void _GenerateHeaders()
        {
            ...
            var h3REct = new RectangleF(h2Rect.Left, h2Rect.Bottom, _mViewport.Rectangle.Width, this.HeaderThreeHeigt);
            var h1LabelRects = new List<RectangleF>();
            var h2LabelRects = new List<RectangleF>();
            var h3LabelRects = new List<RectangleF>();
            var columns = new List<RectangleF>();
            var columns2 = new List<RectangleF>();
            var h1labels = new List<string>();
            var h2labels = new List<string>();
            var h3labels = new List<string>();
            ...
            var h3LabelRect_Y = _mViewport.Y + this.HeaderOneHeight + this.HeaderThreeHeigt;
            var columns2_Y = h3LabelRect_Y + this.HeaderThreeHeigt;
            ...
            _mHeaderInfo.H3LabelRects = h3LabelRects;
            _mHeaderInfo.Columns = columns;
            _mHeaderInfo.Columns2 = columns2;
        ...
        private void _DrawHeader(Graphics graphics, Rectangle clipRect)
        {
            ...
            graphics.FillRectangles(gradient, new RectangleF[] { info.H1Rect, info.H2Rect, info.H3Rect });
            graphics.DrawRectangles(e.Format.Border, new RectangleF[] { info.H1Rect, info.H2Rect, info.H3Rect });
