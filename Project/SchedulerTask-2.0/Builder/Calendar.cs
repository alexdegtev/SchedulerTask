...
namespace Builder
{
    public class Calendar
    {
        ...
        bool SetWorkTime(DateTime startTime, TimeSpan workDuration, out Interval workInterval)
        {
        ...
        bool GetNearestSpareTime(DateTime startDate, out DateTime spareDate)
        {
